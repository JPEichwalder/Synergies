...
conditions  = {'R1_walking'; 'R1_balance'; 'VR1_walking'; 'VR1_balance'; 'VR1_balance_high'}; % changing this names = change names in the script
...
muscles_VAP3 = {'EMG01_m_tib_ant'; 'EMG02_m_pero_long'; 'EMG03_m_gast_med'; 'EMG04_m_glut_max';  'EMG07_m_soleus';  'EMG09_m_qad_med'; 'EMG10_m_qad_lat'; ...
                   'EMG11_m_qad_fem'; 'EMG12_m_gracilis'; 'EMG13_m_tens_fasc_lat'; 'EMG14_m_glut_med'; 'EMG15_m_bic_fem'; 'EMG16_m_semiten'};
...
for prb = 1:nr_prb
  proband = probands{prb};
    ...
    for con = 1:nr_con
      ...
      contrls2  = find(~cellfun(@isempty,contrls1')); %wenn übereinstimmung dann 1 sonst NaN
      ...
      for ctr = 1:nr_ctr % for each trial within one condition
        ...
        if strcmp(proband, 'VAP_1') || strcmp(proband, 'VAP_2')
            muscle_set = muscles_VAP1_2;
           elseif strcmp(proband, 'VAP_3')

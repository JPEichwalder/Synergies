...
function [W, H, iter, varargout] = nmf_bpas_ed (A, k , varargin)
  ...
  parser = inputParser ();
  parser.FunctionName = "nmf_bpas_ed";
  ...
  par.min_iter    = 50; %changed (original 20)
...
%                 0 - None (want to stop by MAX_ITER or MAX_TIME)
    ...
    switch stopRule
        case 1
            ...
            pGrad = [gradW(gradW<0|W>0); gradH(gradH<0|H>0)(:)];%changed (original without (:) at the end)
...
%edited by Kaufmann Paul, changes in line 155, 373, 379